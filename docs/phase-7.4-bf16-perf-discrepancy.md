# Phase 7.4: the BF16 performance discrepancy (OPEN)

**Status:** open. Do not write either number into `docs/perf-experiments.md`
until this is closed.
**Branch:** `phase-7.4-remember-output-dtype`, tip `36e3c8a`.
**Opened:** 2026-08-13.
